<?php
ini_set("sendmail_form", "registration@e-classroom-mba.com");
$message = '
<html>
  <head>
  ...
  <div style="width: 600px; font-family: sans-serif;
    ...
    <div style="padding: 10px;">
      ...
      <p>You are registered <a href="http://e-classroom-mba.com/">E-Classroom</a></p>
...
$to = "morrismoniac@gmail.com";
$subject = 'Registration';
$headers = 'From: registration@e-classroom-mba.com'. "\r\n" .
'Reply-To: registration@e-classroom-mba.com' . "\r\n" .
